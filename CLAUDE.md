...
- ⚠️ **DATOS RETENIDOS POR VERIFICACIÓN ADVERSARIAL (pendiente de confirmar por correo con los ponentes).** Se aplicó el precedente de la Dra. Acosta (§9, 2026-07-02): cuando una atribución está contradicha por fuente institucional, se neutraliza en la ficha y se confirma con la persona.
  - **Reyes — decanatura NO publicada.** Declaró por correo ser «Decano de la Facultad de Derecho de la Universidad Libre seccional Cartagena», pero el directorio oficial vigente de Unilibre (`unilibre.edu.co/cuerpos-colegiados/`) nombra a **Loures/Lourdes Villadiego Coneo** en ese cargo, y la propia Facultad lo listó **sin cargo** como panelista de su Simposio del 15-05-2026. La tarjeta publica solo lo verificado: doctorado (**confirmado**: Universidad de Medellín, título recibido el 07-03-2025) y membresía del **ICDP** (confirmada en el padrón `icdp.org.co/miembros-q-r/`). Tampoco se publicaron en la afiliación: conjuez de la Sala Civil-Familia (sin corroborar) ni el **CCDPC** (no figura entre los 19 miembros numerarios). «Dr.» sí es legítimo.
