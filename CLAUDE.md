...
- **Fotos localizadas** en Drive: Ccolque, Ayllón (foto de edición anterior), Lamas Meza, Rodríguez Zambrano (2025); Vida Carrión la mandó por Gmail (adjunto, sin copiar a Drive). El resto de la Jornada Virtual y la Mesa 10 no tienen foto → monograma. Para añadir una foto: archivo 400×400 en `img/ponentes/` + slug en `programa.json` + mapa `FOTOS` de `programa.py`.
