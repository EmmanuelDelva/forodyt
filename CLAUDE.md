...
- **Sheet *Platicas***: dar de alta los cinco bloques con los ids de `staff-scanner.html` (ver sesión 2026-09-14 (2)).
- **Publicar `en-vivo.html`** cuando el director lo pida: pasos en `docs/en-vivo-asistencia.md` §5.
- **Semblanzas faltantes** (6) y fotos: pedir a Molina Luna el texto en el cuerpo del correo; a Vaca Garfias/Martínez Hurtado, Camarena, Bravo Vergara y Gil Fons, semblanza + foto.
