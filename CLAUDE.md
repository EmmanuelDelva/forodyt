...
- ⚠️ El sitio ahora vive en el **dominio propio `forodyt.com`**; `forodyt.vercel.app` redirige (307) a él. PENDIENTE: el resto de los metadatos (canonical, og:url, hreflang, JSON-LD, robots.txt, i18n.js) aún apuntan a forodyt.vercel.app — falta migrar todo a forodyt.com + dar de alta la propiedad en Search Console. Verificar siempre en `forodyt.com`, no en vercel.app.
