...
(function () {
  ...
  const D = {
    es: {
      ...
      m3_s9_intro_html: 'Continuidad directa de la serie editorial inaugurada con <em>Fronteras Dinámicas: Derecho y Tecnología en la era digital</em> (II Foro, Editorial UDG, 2025). El segundo volumen toma el lema del III Foro como título y compila los <strong>10 papers recibidos por convocatoria abierta</strong> más capítulos invitados de los ponentes magistrales. <strong>Estado actual: en fase de peer review doble ciego.</strong>',
      ...
      m3_s11_title_html: 'Siete piezas que <em>cambiaron</em> con esta edición.',
      ...
      m3_p1_p_html: 'Por primera vez el Foro corre en <strong>paralelo en Torre Smart y Sala de Gobierno</strong>. Lección operativa: el modelo escala y soporta programa simultáneo. Antecedente directo del modelo de sede espejo de la IV edición.',
      m3_p2_h: 'Primera mesa interinstitucional de seguridad pública estatal',
      m3_p2_p_html: 'La mesa redonda <em>«IA: potenciando seguridad e inseguridad»</em> articuló por primera vez academia + Consejo Estatal de Seguridad Pública de Jalisco + Intrado + KMS Technology + El Colegio de Jalisco + SECIHTI en un mismo formato.',
      ...
      m3_p5_p_html: 'Continuidad de la serie editorial UDG iniciada con <em>Fronteras Dinámicas</em>. <strong>10 capítulos recibidos vía CFP</strong>, peer review doble ciego en curso. Demuestra que la editorial es proyecto serial, no evento único.',
    ...
    en: {
      ...
      m3_s11_title_html: 'Seven pieces this edition <em>changed</em>.',
      ...
      m3_p1_p_html: 'For the first time the Forum ran <strong>in parallel at Torre Smart and Sala de Gobierno</strong>. Operational lesson: the model scales and supports simultaneous programming. Direct antecedent of the IV edition\'s mirror-venue model.',
      m3_p2_h: 'First inter-institutional roundtable on state public security',
      m3_p2_p_html: 'The roundtable <em>«AI: empowering security and insecurity»</em> articulated for the first time academia + Jalisco State Public Security Council + Intrado + KMS Technology + El Colegio de Jalisco + SECIHTI in a single format.',
      ...
      m3_p5_p_html: 'Continuity of the UDG editorial series launched with <em>Dynamic Frontiers</em>. <strong>10 chapters received via CFP</strong>, double-blind peer review in progress. Demonstrates the editorial line is serial, not a one-off.',
    ...
    fr: {
      ...
      m3_s9_intro_html: 'Continuité directe de la série éditoriale inaugurée avec <em>Frontières Dynamiques : Droit et Technologie à l\'ère numérique</em> (II<sup>e</sup> Forum, Editorial UDG, 2025). Le deuxième volume prend la devise du III<sup>e</sup> Forum comme titre et compile les <strong>10 communications reçues par appel ouvert</strong> ainsi que les chapitres invités des conférenciers magistraux. <strong>État actuel : en évaluation par les pairs en double aveugle.</strong>',
      ...
      m3_s11_title_html: 'Sept pièces que cette édition a <em>changées</em>.',
      ...
      m3_p1_p_html: 'Pour la première fois le Forum tourne en <strong>parallèle à Torre Smart et Salle de Gouvernement</strong>. Leçon opérationnelle : le modèle est évolutif et supporte une programmation simultanée. Antécédent direct du modèle de site miroir de la IV<sup>e</sup> édition.',
      m3_p2_h: 'Première table ronde interinstitutionnelle sur la sécurité publique étatique',
      m3_p2_p_html: 'La table ronde <em>« IA : potentialisant sécurité et insécurité »</em> a articulé pour la première fois académie + Conseil de Sécurité Publique de Jalisco + Intrado + KMS Technology + El Colegio de Jalisco + SECIHTI dans un même format.',
      ...
      m3_p5_p_html: 'Continuité de la série éditoriale UDG inaugurée avec <em>Frontières Dynamiques</em>. <strong>10 chapitres reçus via AAC</strong>, évaluation par les pairs en double aveugle en cours. Démontre que l\'éditorial est un projet sériel, non événement unique.',
